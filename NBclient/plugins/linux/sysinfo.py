...
import commands  # py3中被subprocess替代
import re
...
def cpuinfo():
    ...
    raw_data = {
        'cpu_model': "%s |grep 'model name' |head -1 " % base_cmd,  # 开头1行
        'cpu_count':  "%s |grep  'processor'|wc -l " % base_cmd,    # L, 有多少行
